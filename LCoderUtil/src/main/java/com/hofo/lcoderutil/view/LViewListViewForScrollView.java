 ...
 */
public class LViewListViewForScrollView extends ListView {
    public LViewListViewForScrollView(Context context) {
        super(context);
    }

    public LViewListViewForScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LViewListViewForScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public LViewListViewForScrollView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
